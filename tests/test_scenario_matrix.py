    ...
    def test_declared_stream_variants_change_model_input_and_keep_ids_unique(self) -> None:
        variants = {
            ...
            for name in (
                ...
                "permute-000-71", "permute-000-79", "permute-000-89",
                "permute-000-97", "permute-001-73", "permute-001-83",
                "permute-001-101", "permute-001-107",
                ...
                "permute-000-181", "permute-000-191", "permute-000-193",
                "permute-000-197", "permute-001-181", "permute-001-191",
                "permute-001-193", "permute-001-197",
            )
        }
