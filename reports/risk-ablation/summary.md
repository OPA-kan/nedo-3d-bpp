...
- episode rows: 38; arms compare the submission-default baseline (off) with live mechanics rerank (RELEASE_RISK_LIVE_RERANK=1, RELEASE_RISK_P_MODEL=mech).
