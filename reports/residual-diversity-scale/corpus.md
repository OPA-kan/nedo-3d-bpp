...
- Runs retained: 14
- Size: 292 MB raw, about 20 MB stored
- Distinct states (board fingerprints): **178** across 9 cases and 96 (case, step) slots
- States reached by more than one run: 84
...
- Rows across all runs: negative_physical_risk 7743, paired_random_control 12659, positive_transition 12751
