...
- Runs retained: 6
- Size: 116 MB raw, about 8 MB stored
- Distinct states (board fingerprints): **139** across 9 cases and 96 (case, step) slots
- States reached by more than one run: 44
...
- Rows across all runs: negative_physical_risk 3291, paired_random_control 4921, positive_transition 4958
