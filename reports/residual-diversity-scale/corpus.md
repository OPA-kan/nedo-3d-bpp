...
- Runs retained: 13
- Size: 270 MB raw, about 18 MB stored
- Distinct states (board fingerprints): **176** across 9 cases and 96 (case, step) slots
- States reached by more than one run: 80
...
- Rows across all runs: negative_physical_risk 7146, paired_random_control 11715, positive_transition 11797
