...
- Runs retained: 11
- Size: 225 MB raw, about 15 MB stored
- Distinct states (board fingerprints): **171** across 9 cases and 96 (case, step) slots
- States reached by more than one run: 74
...
- Rows across all runs: negative_physical_risk 5999, paired_random_control 9718, positive_transition 9789
