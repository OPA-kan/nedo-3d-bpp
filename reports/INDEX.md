...
| superseded | 2026-08-10 | `reports/learnability/summary.md` | `phi-does-not-outrank-the-incumbent-score-on-the-retained-corpus` (superseded), `phi-learning-curve-saturates-near-sixteen-states` (superseded) |
...
| superseded | 2026-08-11 | `reports/residual-diversity-scale/corpus.md` | `phi-signal-is-in-settle-displacement-not-in-safety-ranking` (superseded) |
