...
- snapshot: `reports/replay-dataset/20260731_014746-b001-k20-weighted-class_aware-shadow-2e6de0af-837abea4e973/step-015-state.json`
- case / step: `b001-k20` / 15
- repeats: 1
- item top-K: 10
- Q-live band: 0.15
...
|---|---|---:|---:|---:|
| off | [7] | 5.033s | 5.033-5.033s | 1 |
| future-option | [7] | 5.052s | 5.052-5.052s | 1 |

## Per run

| arm | repeat | item | elapsed | action hash | future changed | aborted |
|---|---:|---:|---:|---|---|---|
| off | 0 | 7 | 5.033s | `a3544f2d29e1e0c7` |  |  |
| future-option | 0 | 7 | 5.052s | `a3544f2d29e1e0c7` | False | False |
